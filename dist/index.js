...
class Client {
    ...
    getProjectUID(projectName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return c.get(`/v1alpha1/projects?filters=metadata.name=${projectName}`)
                ...
                .then(data => {
                var _a;
                if (!data || !((_a = data.items) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    getClusterProfileUID(projectUID, clusterProfileName) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = yield this.getClient();
    ...
    getCloudAccountUID(projectUID, cloudType, cloudAccountName) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = yield this.getClient();
    ...
    getCluster(projectUID, clusterUID) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = yield this.getClient();
    ...
    createCluster(projectUID, cloudType, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = yield this.getClient();
...
function waitForState(operation, targetState, pendingStates, attempts, delayMs) {
    return __awaiter(this, void 0, void 0, function* () {
        for (let i = 0; i < attempts; i++) {
            const state = yield operation(i);
...
function getClusterStateFunc(c, projectUid, clusterUid) {
    return (attempt) => __awaiter(this, void 0, void 0, function* () {
        const cluster = yield c.getCluster(projectUid, clusterUid);
        const state = cluster.status.state;
        return state;
    });
}
function deployCluster(cred, clusterTemplate, clusterName) {
    return __awaiter(this, void 0, void 0, function* () {
        const cluster = js_yaml_1.default.load(clusterTemplate);
        const c = new client_1.default(cred.host, cred.username, cred.password);
        const { cloudType, projectName, labels, cloudConfig, machinePools } = cluster;
        const projectUid = yield c.getProjectUID(projectName);
        const [profileUid, cloudAccountUid] = yield Promise.all([
        ...
        const mpc = function (mp) {
            const { name, controlPlane, controlPlaneAsWorker, count, config } = mp;
            return {
                poolConfig: {
                    name,
                    size: count,
